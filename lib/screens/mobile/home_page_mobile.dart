...
class PruebaAppMobile extends StatefulWidget {
  const PruebaAppMobile({super.key, this.title = 'Prueba App Mobile'});
  final String title;

  @override
  State<PruebaAppMobile> createState() => _PruebaAppMobileState();
}

class _PruebaAppMobileState extends State<PruebaAppMobile> {
  int _counter = 0;
